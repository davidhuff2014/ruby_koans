...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # TODO below sounds right is it?
    # Adds an additional accumulator variable to the block, the argument defines the initial value
  end
  ...
  # TODO don't think we want to assign an action or file handle to a variable to do this
